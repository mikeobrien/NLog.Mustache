...
The first example references the `Id` property of the log info `Exception` property. The second references the `Id` property of the current exception by passing in a `.`.